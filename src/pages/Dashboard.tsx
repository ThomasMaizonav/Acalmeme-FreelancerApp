          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                {isInFreeTrial 
                  ? `Período grátis: ${freeTrialDaysLeft} dias restantes`
                  : isPremium 
                    ? "Plano Premium ativo"
                    : "Seus medicamentos estão em dia?"
                }
              </p>
            </div>
          </div>
      ...
      <main className="px-4 sm:px-6 py-6 sm:py-8 max-w-6xl mx-auto">
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-bold mb-1">Lembretes de Medicação</h2>
                <p className="opacity-90 text-sm sm:text-base">Configure seus horários e receba alertas</p>
              </div>
            </div>
            <Button
              variant="secondary"
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">Bônus incluídos</h3>
          </div>
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">Diário Emocional</h3>
              <p className="text-sm text-muted-foreground">
                Registre seus sentimentos e acompanhe seu bem-estar
              </p>
            </Card>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">Sessões de Calma</h3>
              <p className="text-sm text-muted-foreground">
                Exercícios de respiração com música relaxante
              </p>
            </Card>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">Modo Crise</h3>
              <p className="text-sm text-muted-foreground">
                Apoio imediato para momentos difíceis
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="p-6 sm:p-8 glass shadow-soft">
            <h3 className="text-lg font-semibold mb-6">Seu Progresso</h3>
        ...
        {isPremium ? (
          <Card className="p-6 sm:p-8 bg-gradient-to-r from-secondary/10 to-accent/10 border-secondary/20 shadow-calm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-semibold">Você é Premium! 🎉</h3>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-xl font-semibold">Período de Teste Grátis</h3>
                </div>
                <p className="text-muted-foreground mb-4">
                  Você ainda tem <strong>{freeTrialDaysLeft} dias</strong> de acesso gratuito. 
                  Assine para não perder nenhum recurso!
                </p>
          ...
          <Card className="p-6 sm:p-8 bg-gradient-to-r from-secondary/10 to-accent/10 border-secondary/20 shadow-calm">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  Desbloqueie todos os recursos: lembretes ilimitados, diário completo e muito mais
                </p>
                <Button variant="premium" onClick={() => navigate("/plans")}>
                  Assinar agora
                </Button>
