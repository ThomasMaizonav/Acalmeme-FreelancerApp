  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/10 via-background to-secondary/10 flex flex-col">
      <div className="p-4 sm:p-6 flex items-center justify-between">
        ...
        <h1 className="text-lg font-semibold">Sessao de Calma</h1>
        <Button
          variant="ghost"
          size="icon"
      ...
      {!sessionStarted ? (
        <div className="flex-1 flex items-center justify-center px-4">
          <Card className="w-full max-w-md p-6 sm:p-8 text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Escolha a duracao</h2>
            ...
            <p className="text-sm text-muted-foreground">
              {soundEnabled ? "🎵 Musica leve ativada" : "🔇 Musica desativada"}
            </p>
          </Card>
        </div>
      ) : (
          ...
          <div className="flex-1 flex items-center justify-center px-6">
            <Card className="w-full max-w-md p-6 sm:p-8 text-center">
              <p className="text-sm text-muted-foreground mb-2">
                {selectedDuration ? `Sessao de ${Math.floor(selectedDuration / 60)} min` : "Sessao"}
              </p>
            ...
            {timeRemaining > 0 ? (
              ...
              <Card className="p-6 rounded-2xl max-w-md mx-auto text-center">
                <p className="text-lg font-medium mb-4">
                  🎉 Parabens! Voce completou a sessao.
                </p>
                <p className="text-muted-foreground mb-6">
